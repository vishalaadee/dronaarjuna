...
app.config['MYSQL_HOST']='https://dronaarjuna.000webhostapp.com/'
app.config['MYSQL_USER']='root'
app.config['MYSQL_PASSWORD']='Tujaanenaaadeez@29'
...
@app.route('/')
def index():
    return render_template(template_name_or_list='Sindex.html')
